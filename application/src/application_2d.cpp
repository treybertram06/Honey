...
void Application2D::on_attach() {
    ...
    m_chuck_texture = Honey::Texture2D::create("C:/Users/treyb/CLionProjects/engine/application/assets/textures/bung.png");
    m_missing_texture = Honey::Texture2D::create("C:/Users/treyb/CLionProjects/engine/application/assets/textures/missing.png");
...
void Application2D::on_update(Honey::Timestep ts) {
     ...
     // update
        ...
        Honey::Renderer2D::draw_quad({0.0f, 1.0f}, {0.5f, 0.5f}, m_chuck_texture);
